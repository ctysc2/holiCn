...
public class FileTypeUtils {
    ...
    public enum FileType {
        DIRECTORY(R.drawable.ico_document, R.string.type_directory),
        ...
        EXCEL(R.drawable.ico_excel, R.string.type_excel, "xls", "xlk", "xlsb", "xlsm", "xlsx", "xlr", "xltm", "xlw", "numbers", "ods", "ots"),
        ...
        PDF(R.drawable.ico_pdf, R.string.type_pdf, "pdf"),
        POWER_POINT(R.drawable.ico_ppt, R.string.type_power_point, "pptx", "keynote", "ppt", "pps", "pot", "odp", "otp"),
        WORD(R.drawable.ico_word, R.string.type_word, "doc", "docm", "docx", "dot", "mcw", "rtf", "pages", "odt", "ott"),
