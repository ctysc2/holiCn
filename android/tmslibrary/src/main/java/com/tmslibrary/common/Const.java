...
public class Const {
    ...
    public final static int REQUEST_FILE = 1001;
    ...
    public static int LESSON_PREVIEW_HEIGHT = LESSON_PREVIEW_WIDTH*9/16;


    public static int LESSON_PREVIEW_WIDTH_MIDDLE = 140;
    public static int LESSON_PREVIEW_HEIGHT_MIDDLE = LESSON_PREVIEW_WIDTH_MIDDLE*9/16;


    public static int LARGE_PREVIEW_WIDTH_16_9 = 180;
    public static int LARGE_PREVIEW_HEIGHT_16_9 = LARGE_PREVIEW_WIDTH_16_9*9/16;
