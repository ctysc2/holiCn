...
public class UpdateDownloadCountInteractorImpl implements UpdateDownloadCountInteractor<BaseErrorEntity> {

    private final String API_TYPE = "updateDownLoadCount";


    @Inject
    public UpdateDownloadCountInteractorImpl(){

    }

    @Override
    public Subscription updateDownloadCount(final RequestCallBack<BaseErrorEntity> callback, String id) {
        return RetrofitManager.getInstance(API_TYPE).updateDownloadCount(id)
