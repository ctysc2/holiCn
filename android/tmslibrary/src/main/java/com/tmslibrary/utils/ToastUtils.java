...
public final class ToastUtils {
    ...
    private static int yOffset         = (int) (64 * TmsLibraryApp.getInstances().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate = (LayoutInflater) TmsLibraryApp.getInstances().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void init(){
        ...
        yOffset         = (int) (64 * TmsLibraryApp.getInstances().getResources().getDisplayMetrics().density + 0.5);
    }
    ...
    private static void show(@StringRes int resId, int duration) {
        show(TmsLibraryApp.getInstances().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(TmsLibraryApp.getInstances().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(TmsLibraryApp.getInstances());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(TmsLibraryApp.getInstances(), spannableString, duration);
            } else {
                sToast = Toast.makeText(TmsLibraryApp.getInstances(), text, duration);
            }
        }
