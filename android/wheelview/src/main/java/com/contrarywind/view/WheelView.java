...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        Log.i("textSizetextSize","textSize1:"+textSize);
        if (attrs != null) {
        ...
        Log.i("textSizetextSize","textSize2:"+textSize);
        judgeLineSpace();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle > 90F || angle < -90F) {
                ...
                //获取内容文字
                //Log.i("labellabel",label);
                String contentText = getContentText(showText);
                if(contentText.equals("-1") && (label.equals("时") || label.equals("分") || label.equals("秒"))){
                    contentText = "未知";
                }else if (contentText.equals("1969") && (label.equals("年"))){
                    contentText = "未知";
                }else if(contentText.equals("00") && (label.equals("月"))){
                    contentText = "未知";
                }else if(contentText.equals("00") && (label.equals("日"))){
                    contentText = "未知";
                }
    ...
    private void reMeasureTextSize(String contentText) {
        ...
        int size = textSize;
        Log.i("textSizetextSize","reMeasureTextSize:"+textSize);
