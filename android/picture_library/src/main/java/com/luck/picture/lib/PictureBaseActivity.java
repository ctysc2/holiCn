...
public abstract class PictureBaseActivity extends AppCompatActivity {
    ...
    private void initConfig() {
        ...
        if (config.style != null) {
            ...
            //ops
            colorPrimary = getResources().getColor(R.color.picture_color_white);
            colorPrimaryDark = getResources().getColor(R.color.picture_color_white);
            openWhiteStatusBar = true;
        }
    ...
    protected void startOpenCamera() {
        Log.i("AAAAA","startOpenCamera");
        Intent cameraIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        //if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            Log.i("AAAAA","startOpenCamera 1");
            Uri imageUri;
            if (SdkVersionUtils.checkedAndroid_Q()) {
                Log.i("AAAAA","startOpenCamera 2");
                ...
                if (imageUri != null) {
                    ...
                    Log.i("AAAAA","startOpenCamera 3");
                    return;
                }
            } else{
                Log.i("AAAAA","startOpenCamera 4");
