...
public class PictureAlbumDirectoryAdapter extends RecyclerView.Adapter<PictureAlbumDirectoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(isChecked){
            holder.tvFolderName.setTextColor(Color.parseColor("#0091ff"));
        }else{
            holder.tvFolderName.setTextColor(Color.parseColor("#222222"));
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            //mSeparate = itemView.findViewById(R.id.v_separate);
