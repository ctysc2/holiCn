package com.mobilemd.cameralibrary.state;

import android.view.Surface;
import android.view.SurfaceHolder;

import com.mobilemd.cameralibrary.CameraInterface;
import com.mobilemd.cameralibrary.JCameraView;
...
public class BorrowPictureState implements State {
    ...
    @Override
    public void switchState(SurfaceHolder holder, float screenProp) {
