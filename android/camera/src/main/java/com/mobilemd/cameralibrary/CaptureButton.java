...
import com.mobilemd.cameralibrary.util.CheckPermission;
import com.mobilemd.cameralibrary.util.LogUtil;

import static com.mobilemd.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static com.mobilemd.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.mobilemd.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private void startCaptureAnimation(float inside_start) {
        ...
        inside_anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                //回调拍照接口
                if(captureListener.canTakePhoto()){
        ...
        set.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (state == STATE_LONG_PRESS) {
                    if (captureListener != null && captureListener.canRecorder()){
    ...
    private void updateProgress(long millisUntilFinished) {
        ...
        if (captureListener != null)
            captureListener.recordMillions(recorded_time);
        invalidate();
    }
