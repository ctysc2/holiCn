package com.bigkoo2.pickerview.builder;
...
import com.bigkoo2.pickerview.listener.CustomListener;
import com.bigkoo2.pickerview.listener.OnIncompleteTimeSelectListener;
import com.bigkoo2.pickerview.listener.OnTimeSelectChangeListener;
...
public class TimePickerBuilder {
    ...
    //Required
    public TimePickerBuilder(Context context, OnIncompleteTimeSelectListener listener) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_TIME);
        mPickerOptions.context = context;
        mPickerOptions.incompleteTimeSelectListener = listener;
        mPickerOptions.isIncomplete = true;
    }
    ...
    public TimePickerBuilder setDateString(String date) {
        mPickerOptions.dateString = date;
        return this;
    }

    public TimePickerBuilder setMaxYear(String year) {
        mPickerOptions.maxYearInCompleted = year;
        return this;
    }
