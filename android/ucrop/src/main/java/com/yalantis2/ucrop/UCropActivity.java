...
import com.yalantis2.ucrop.R;
import com.yalantis2.ucrop.callback.BitmapCropCallback;
import com.yalantis2.ucrop.immersion.CropImmersiveManage;
import com.yalantis2.ucrop.model.AspectRatio;
import com.yalantis2.ucrop.util.FileUtils;
import com.yalantis2.ucrop.util.MimeType;
import com.yalantis2.ucrop.util.ScreenUtils;
import com.yalantis2.ucrop.util.SelectedStateListDrawable;
import com.yalantis2.ucrop.view.CropImageView;
import com.yalantis2.ucrop.view.GestureCropImageView;
import com.yalantis2.ucrop.view.OverlayView;
import com.yalantis2.ucrop.view.TransformImageView;
import com.yalantis2.ucrop.view.UCropView;
import com.yalantis2.ucrop.view.widget.AspectRatioTextView;
import com.yalantis2.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setCropGridRowCount(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_ROW_COUNT, 0));
        mOverlayView.setCropGridColumnCount(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_COLUMN_COUNT, 0));
